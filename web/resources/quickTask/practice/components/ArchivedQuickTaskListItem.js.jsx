...
class ArchivedQuickTaskListItem extends Binder {
  constructor(props) {
    super(props);
    this.state = {
      optionsOpen: false
  ...
  render() {
    ...
    return (
      <div className="table-row">
        ...
        <div className="table-cell">
          <p className="-items">{quickTask.visibility && quickTask.visibility.charAt(0).toUpperCase() + quickTask.visibility.slice(1)}</p>
        </div>
      </div>
    )
  }
...
ArchivedQuickTaskListItem.propTypes = {
  dispatch: PropTypes.func.isRequired
  , quickTask: PropTypes.object.isRequired
}

ArchivedQuickTaskListItem.defaultProps = {

/**
 * View component for /admin/phone-numbers
 *
...
import AdminPhoneNumberListItem from '../components/AdminPhoneNumberListItem.js.jsx';
        ...
        { isEmpty ?
          ...
          <div style={{ opacity: isFetching ? 0.5 : 1 }}>
            <div className="admin-table-wrapper">
              <Link to={'/admin/phone-numbers/new'}> New Phone Number</Link>
              <table className="yt-table striped">
                ...
                <tbody>
                  {phoneNumberListItems.map((phoneNumber, i) =>
                    <AdminPhoneNumberListItem key={phoneNumber._id + i} phoneNumber={phoneNumber} />
                  )}
                </tbody>
              </table>
            </div>

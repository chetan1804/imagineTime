...
class PracticeClientBilling extends Binder {
  constructor(props) {
    super(props);
    this.state = {
      ...
      <ClientSettingsLayout>
        <div className="hero -empty-hero">
          <div className="u-centerText">
            ...
            <h2>{brandingName.title} Billing Module</h2>
            <p>Send invoices & accept payment.</p>
          </div>
        </div>
      </ClientSettingsLayout>
    )
...
PracticeClientBilling.propTypes = {
  dispatch: PropTypes.func.isRequired
}

PracticeClientBilling.defaultProps = {

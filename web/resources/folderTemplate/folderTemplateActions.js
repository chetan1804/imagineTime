...
export const INVALIDATE_SELECTED_FOLDER_TEMPLATE = "INVALIDATE_SELECTED_FOLDER_TEMPLATE"
...
export function fetchSingleFolderTemplateById(id) {
  return dispatch => {
    ...
    return apiUtils.callAPI(`/api/folder-template/${id}`)
      .then(json => dispatch(receiveSingleFolderTemplate(json)))
  }
}

export const ADD_SINGLE_FOLDER_TEMPLATE_TO_MAP = "ADD_SINGLE_FOLDER_TEMPLATE_TO_MAP";
...
export function fetchDefaultFolderTemplate() {
  return dispatch => {
    ...
    return apiUtils.callAPI(`/api/folder-template/default`)
...
function receiveFolderTemplateSchema(json) {
 ...
 export function fetchFolderTemplateSchema() {
  return dispatch => {
    ...
    return apiUtils.callAPI(`/api/folder-template/schema`)
...
export function sendCreateFolderTemplate(data) {
  return dispatch => {
    ...
    return apiUtils.callAPI('/api/folder-template', 'POST', data)
...
export function sendApplyFolderTemplate(data) {
  return dispatch => {
    ...
    return apiUtils.callAPI('/api/folder-template/apply', 'POST', data)
      .then(json => dispatch(receiveApplyFolderTemplate(json)))
  }
}

export const REQUEST_BULK_APPLY_FOLDER_TEMPLATE = "REQUEST_BULK_APPLY_FOLDER_TEMPLATE";
...
export const RECEIVE_BULK_APPLY_FOLDER_TEMPLATE = "RECEIVE_BULK_APPLY_FOLDER_TEMPLATE";
...
export function sendBulkApplyFolderTemplate(data) {
  return dispatch => {
    ...
    return apiUtils.callAPI('/api/folder-template/bulk-apply', 'POST', data)
...
export function sendCreateRequestChanges(data) {
  return dispatch => {
    dispatch(requestCreateFolderTemplate(data))
    return apiUtils.callAPI('/api/folder-template/request-changes', 'POST', data)
      .then(json => dispatch(receiveCreateFolderTemplate(json)))
  }
}
...
export function sendUpdateFolderTemplate(data) {
  return dispatch => {
    ...
    return apiUtils.callAPI(`/api/folder-template/${data._id}`, 'PUT', data)
...
export function sendBulkUpdateFolderTemplate(data) {
  return dispatch => {
    ...
    return apiUtils.callAPI(`/api/folder-template/bulk-update/${data._client}`, 'PUT', data)
      .then(json => {
        if (json.success) {
...
export function sendDelete(id) {
  return dispatch => {
    ...
    return apiUtils.callAPI(`/api/folder-template/${id}`, 'DELETE')
...
export const returnFolderTemplateListPromise = (...listArgs) => (dispatch, getState) => {
  /**
...
export const REMOVE_FOLDER_TEMPLATE_FROM_LIST = "REMOVE_FOLDER_TEMPLATE_FROM_LIST"
...
export function fetchList(...listArgs) {
  return dispatch => {
    ...
    return apiUtils.callAPI(apiTarget).then(
      json => dispatch(receiveFolderTemplateList(json, listArgs))
    )
  }
}
...
export const REQUEST_DELETE_ROOT_FOLDER_TEMPLATE = "REQUEST_DELETE_ROOT_FOLDER_TEMPLATE";
...
export const RECEIVE_DELETE_ROOT_FOLDER_TEMPLATE = "RECEIVE_DELETE_ROOT_FOLDER_TEMPLATE";
...
export function sendDeleteRootFolderTemplate(id) {
  return dispatch => {
    ...
    return apiUtils.callAPI(`/api/folder-template/delete/${id}`, 'DELETE')

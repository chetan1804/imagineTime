...
class InvoicePortalList extends Binder {
  constructor(props) {
    super(props);
    this.state = {
      isFetching: false,
  ...
  render() {
    ...
    const firmId =
      ...
      clientStore.byId[match.params.clientId]._firm;
    ...
    const selectedFirm = firmStore && firmStore.byId[firmId];
...
export default withRouter(connect(mapStoreToProps)(InvoicePortalList));

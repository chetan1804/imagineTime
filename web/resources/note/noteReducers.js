...
function note(state = {
  ...
  /**
   * "defaultItem" defines fields for a _new_ note
   * any component that creates a new note object should store a copy of this
   * in its state
   */
  , defaultItem: {
    error: null
  ...
  , displayColumns: null
  , filterNames: {associationFilter: null}
  , filter: {
    firmId: null
    , orderBy: 'id'
  ...
  switch(action.type) {
    ...
    case Actions.REQUEST_NOTE_SCHEMA: {
      nextState = {
        ...state
        , defaultItem: {
          ...state.defaultItem
    ...
    case Actions.RECEIVE_NOTE_SCHEMA: {
      if(action.success) {
        nextState = {
          ...state
          , defaultItem: {
    ...
    case Actions.SET_SELECTED_NOTE: {
      // add this note to the map and set it as selected
      nextState = {
        ...state
        , byId: {
          ...state.byId
    ...
    case Actions.SET_NOTELIST2_FILTER: {
      nextState = {
        ...state
    ...
    case Actions.SET_NOTELIST2_DISPLAY_COLUMNS: {
      nextState = {
        ...state

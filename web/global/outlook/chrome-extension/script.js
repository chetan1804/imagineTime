...
if (!existImagine) {
    ...
    imagineIconHeader.src = "https://app.imaginetime.com/img/icon-64.png";
    ...
    imagineTitleHeader.innerText = "ImagineShare (Demo)";
    ...
    imagineIframe.src = "https://app.imaginetime.com/outlook";

            ...
            <div className="content">
              <div className="main-copy with-eyebrow">
                ...
                <div className="eyebrow content">
                  <h1>Heading 1 <br/>
                  <span style={{"fontWeight":100}}>Heading 1 - 100</span><br/>
                  <span style={{"fontWeight":200}}>Heading 1 - 200</span><br/>
                  <span style={{"fontWeight":300}}>Heading 1 - 300</span><br/>
                  <span style={{"fontWeight":400}}>Heading 1 - 400</span><br/>
                  <span style={{"fontWeight":500}}>Heading 1 - 500</span><br/>
                  <span style={{"fontWeight":600}}>Heading 1 - 600</span><br/>
                  <span style={{"fontWeight":700}}>Heading 1 - 700</span><br/>
                  <span style={{"fontWeight":800}}>Heading 1 - 800</span><br/>
                  <span style={{"fontWeight":900}}>Heading 1 - 900</span><br/>
                  </h1>
                  <h2>Heading 2<br/>
                  <span style={{"fontWeight":100}}>Heading 2 - 100</span><br/>
                  <span style={{"fontWeight":200}}>Heading 2 - 200</span><br/>
                  <span style={{"fontWeight":300}}>Heading 2 - 300</span><br/>
                  <span style={{"fontWeight":400}}>Heading 2 - 400</span><br/>
                  <span style={{"fontWeight":500}}>Heading 2 - 500</span><br/>
                  <span style={{"fontWeight":600}}>Heading 2 - 600</span><br/>
                  <span style={{"fontWeight":700}}>Heading 2 - 700</span><br/>
                  <span style={{"fontWeight":800}}>Heading 2 - 800</span><br/>
                  <span style={{"fontWeight":900}}>Heading 2 - 900</span><br/>
                  </h2>

...
class DesktopNotAllowed extends Binder {
  constructor(props) {
    super(props);
    ...
    return (
      <div className="yt-container">
        <div className="yt-row" style={{ marginTop: "8px" }}>
          <h1>Whoops!</h1>
          <strong>It looks like you don't have an active ImagineTime account.</strong>
          <hr />
          <br />
          <p>Unfortunately, that means you're unable to use Secure Print at this time.</p>
          <br />
...
export default withRouter(connect(mapStoreToProps)(DesktopNotAllowed));

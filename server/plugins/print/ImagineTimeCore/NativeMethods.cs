...
namespace ImagineTimeCore
{
    ...
    public struct DRIVER_INFO_6
    {
        ...
        [MarshalAs(UnmanagedType.LPTStr)] public string psPreviousNames;
    ...
    internal static class NativeMethods
    {
        ...
        internal static extern bool EnumMonitors(string pName, uint level, IntPtr pMonitors, uint cbBuf,
        ...
        [DllImport("winspool.drv", CharSet = CharSet.Auto, CallingConvention = CallingConvention.StdCall,
            SetLastError = true)]
        ...
        [DllImport("winspool.drv", CharSet = CharSet.Auto, SetLastError = true)]
        internal static extern bool EnumPrinterDrivers(String pName, String pEnvironment, uint level,
            IntPtr pDriverInfo, uint cdBuf, ref uint pcbNeeded, ref uint pcReturned);
